...
public class EnrollmentDaoImpl implements EnrollmentDao {
	...
	private static final String ADD_ENROLLMENT = "insert into enrollment(bid,sid) values(?,?)";
	...
	private static final String REMOVE_BY_BATCHID= " delete from enrollment where bid=?";
